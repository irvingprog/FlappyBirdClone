...
var Rectangulo = (function (_super) {
    ...
    function Rectangulo(fisica, x, y, ancho, alto, opciones) {
        ...
        this._escala = 1;
        this._ancho = convertir_a_metros(ancho);
        this._alto = convertir_a_metros(alto);
        ...
        polygonShape.SetAsBox(this._ancho / 2, this._alto / 2);
    ...
    Rectangulo.prototype.definir_vertices = function () {
        var fixture = this.cuerpo.GetFixtureList();

        if (fixture) {
            var shape = fixture.GetShape();
            shape.SetAsBox(this._ancho / 2, this._alto / 2);
        }
    };


    Object.defineProperty(Rectangulo.prototype, "ancho", {
        get: function () {
            return convertir_a_pixels(this._ancho);
        },
        set: function (ancho) {
            if (ancho instanceof Array) {
                pilas.interpolar(this, "ancho", ancho, 1);
            } else {
                this._ancho = convertir_a_metros(ancho);
                this.definir_vertices();
            }
        },
        enumerable: true,
        configurable: true
    ...
    Object.defineProperty(Rectangulo.prototype, "alto", {
        get: function () {
            return convertir_a_pixels(this._alto);
        },
        set: function (alto) {
            if (alto instanceof Array) {
                pilas.interpolar(this, "alto", alto, 1);
            } else {
                this._alto = convertir_a_metros(alto);
                this.definir_vertices();
            }
...
var Imagenes = (function () {
    ...
    Imagenes.prototype.cargar_recursos = function () {
        ...
        /*Flappy Game*/
        this.cargar_recurso('flappyfondo.png');
        this.cargar_recurso('flappybird.png');
        this.cargar_recurso('flappypiso.png');
        this.cargar_recurso('flappytubo.png');
        /*end flappy game*/
